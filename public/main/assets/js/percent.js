    ...
    2536: function (e, t, i) {
              ...
              r < 0 && (r = a + r),
                b.each(this._dataItems, (e) => {
                  ...
                  if (n) {
                    ...
                    const l = e.get("fillPattern");
                    n._setDefault("fillPattern", l);
                  }
      ...
      Object.defineProperty(D, "className", {
        ...
        Object.defineProperty(D, "classNames", {
          ...
          configurable: !0,
          writable: !0,
          value: g.T.classNames.concat([D.className]),
        });
      var A = i(962);
      class T extends m {
        constructor() {
          ...
          if (
            ...
            b.each(this._dataItems, (e) => {
              ...
              t._setDefault("fill", r),
                ...
                t._setDefault("fillPattern", n),
                l._setDefault("fill", r),
                l._setDefault("stroke", r);
              const o = e.get("value");
              p.isNumber(o) &&
                (0 == o && this.get("ignoreZeroValues")
      ...
      class L extends T {
        ...
        decorateSlice(e) {
          ...
          let D = _.relativeToValue(d, v),
            A = this._nextSize,
            T = Math.atan2(f, C - D),
            L = Math.tan(Math.PI / 2 - T);
          if ((0 == L && (L = 1e-8), "area" == n)) {
            let e = (((C + D) / 2) * f * g) / o,
              t = Math.abs(A * A - 2 * e * L);
            (m = (A - Math.sqrt(t)) / L), (y = m > 0 ? (2 * e - m * A) / m : A);
          } else (m = (f * g) / o), (y = A - m * L);
